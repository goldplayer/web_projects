  ...
  <div class="container">
      ...
      <div class="caption_block mt-5">
          ...
          <!-- comments -->
              ...
              <div class="comments_block">
                  ...
                  <?php
                    if(isset($_POST['send_comment'])){
                      ...
                      $query_for_counter_comment = "UPDATE posts SET post_comment = post_comment + 1
                        WHERE id_post = $the_post_id";
                      $update_counter_comments = mysqli_query($connect, $query_for_counter_comment);
                    }            
              ...
              <hr>
                <?php 
                  $qry_select_comments = "SELECT * FROM comments WHERE comments_post_id = {$the_post_id}
                  AND comments_status = 'approved'
                  ORDER BY comments_id DESC
                  ";
                  $query_select_comment_for_post = mysqli_query($connect, $qry_select_comments);

                  if(!$query_select_comment_for_post){
                      die("Failed" . mysqli_error($connect));
                  }
                    // echo " <hr>";
                  while($row = mysqli_fetch_array($query_select_comment_for_post)){
                      ...
                      <div class="comments_user_block">
                          ...
                          <div class="comments_user_block_content">
                              <div class="comment_header">
                                  <h3><?php echo $comments_author ?></h3>
                                  <small><?php echo $comments_date ?></small>
                                  
                              </div>
                              <div class="comment_text">
                                  <p><?php echo $comments_content ?></p>
                              </div>
                          </div>
                      </div>
                      <hr>
